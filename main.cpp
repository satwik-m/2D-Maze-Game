 ...
 void frontscreen(void)
{
	...
	drawstring(-45,5,"Maximize window for complete view",GLUT_BITMAP_HELVETICA_12);
    glColor3f(1,1,1);
	output(5,160," COMPUTER GRAPHICS");
	//glColor3f(1,1,1);
	//output(10.0,150,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	glColor3f(1,0,1);
	output(60,130,"A Mini Project On:");
	glColor3f(0,1,0.5);
	output(38,120,"\"2D MAZE USING OPENGL\"");
	glColor3f(1,0,1);
	output(180,100,"By :");
	glBegin(GL_LINES);
	glVertex2f(180,98);
	...
	glEnd();
	glColor3f(1,0,0);
	output(180,90,"Shireesh- 16IT147");
	output(180,80,"Rakesh  - 16IT130");
    output(180,70,"Satwik  - 16IT119");
	output(180,60,"Bharath - 16IT146");
	glColor3f(1,0,1);
	output(180,40,"Submitted to:");
	glBegin(GL_LINES);
	glVertex2f(180,38);
	glVertex2f(210,38);
	glEnd();
	...
	//output(40,50,"");
	glColor3f(1,0,0);
	drawstring(180,30,"Mrs. Sangeetha",GLUT_BITMAP_TIMES_ROMAN_24);
	glColor3f(1,0,0);
	//output(100,40,"Lecturer,Dept. of CSE");
	//glColor3f(1,0,0);
	//output(40,30,"");
	//glColor3f(1,0,0);
...
glClear(GL_COLOR_BUFFER_BIT);
glColor3f(0.0,1.0,0.0);
output(25,140,"WELCOME TO THE GAME 2D MAZE");
output(50,100,"1.START GAME");
...
void instructions()
{
  ...
  output(-20,100,"* FIND THE WAY TO MOVE THROUGH THE MAZE AND GET OUT");
